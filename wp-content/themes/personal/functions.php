<?php
/**
 * Personal1 functions and definitions
 *
...
if ( ! defined( 'PERSONAL1_VERSION' ) ) {
	// Replace the version number of the theme on each release.
	define( 'PERSONAL1_VERSION', '1.0.0' );
}
...
function personal_setup() {
	/*
		...
		* If you're building a theme based on Personal1, use a find and replace
...
function personal_scripts() {
	wp_enqueue_style( ' personal-style', get_stylesheet_uri(), array(), PERSONAL1_VERSION );
	wp_style_add_data( ' personal-style', 'rtl', 'replace' );

	wp_enqueue_script( ' personal-navigation', get_template_directory_uri() . '/js/navigation.js', array(), PERSONAL1_VERSION, true );
